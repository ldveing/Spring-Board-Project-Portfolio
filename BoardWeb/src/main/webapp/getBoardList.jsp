...
<div class="container">
	...
	<div class="a_tags">
		<a href="getBoardList.do?lang=en"><spring:message code="message.member.login.language.en"/></a> | 
		<a href="getBoardList.do?lang=ko"><spring:message code="message.member.login.language.ko"/></a>
	</div>
	<div class="d1">
		<div class="d1_1">
			${memberId }<spring:message code="message.board.list.welcomeMessage"/>&emsp;

...
.a_tags { text-align: center; text-decoration: none; font-weight: bold; color: #000;}
...
<div class="container">
	...
	<div class="a_tags">
		<a href="login.do?lang=en"><spring:message code="message.member.login.language.en"/></a> | 
		<a href="login.do?lang=ko"><spring:message code="message.member.login.language.ko"/></a>
	</div>
	<br>
	...
	<table>
		...
		<tr>
			<td colspan="2"><input type="submit" value="<spring:message code="message.member.login.loginbButton"/>"></td>
		</tr>
	</table>
	</form>
</div>

...
public class PageDTO {
	...
	public PageDTO(BlockDTO block, int total) {
		...
		this.pageCount = total / block.getAmount() + (total / block.getAmount() == 0 ? 0 : 1);
		...
		int endPage2 = (int) (Math.ceil(total * 1.0) / block.getAmount()) + ((Math.ceil(total * 1.0) / block.getAmount()) == 0 ? 0 : 1); // 실제 endPage

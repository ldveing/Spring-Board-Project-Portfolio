...
public class MemberController {
	...
	public String login(MemberDTO dto, HttpSession session, BlockDTO block) {
	...
	@RequestMapping(value="/checkIdMember.do")
